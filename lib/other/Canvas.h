...
public:
	...
	void Chord(int x1, int y1, int x2, int y2, int xint1, int yint1, int xint2, int yint2)
	{
		::Chord(_hdc, x1, y1, x2, y2, xint1, yint1, xint2, yint2);
	}

	void Pie(int x1, int y1, int x2, int y2, int xint1, int yint1, int xint2, int yint2)
	{
		::Pie(_hdc, x1, y1, x2, y2, xint1, yint1, xint2, yint2);
	}

	void Arc(int x1, int y1, int x2, int y2, int xint1, int yint1, int xint2, int yint2)
	{
		::Arc(_hdc, x1, y1, x2, y2, xint1, yint1, xint2, yint2);
	}
